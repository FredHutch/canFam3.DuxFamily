...
### ERVL-MaLR
The bar plot below displays signicantly expressed ERVL-MaLR elements in either CinC, HinC or HinH ($adj-p < 0.05$). Only _MLT1A1_ and _MLT1A0-int_ have higher copy number in human (ratio > 2) compared to canine (ratio > 0), but they don't have higher induction in human. 
...
### ERVL
Shown below is the significently expressed ERVL elememts expression in either CinC, HinC, or HinH. _MER21B_ and _MER21-int_ have highr copy number in human.
...
```{r plot-ERV1-logFC, warning=FALSE, fig.height=6, fig.cap="repName expression (logFC) in ERV1 family in CinC, HinC and HinH; Orange indicates up/down-regulation; * indicates higher copy number in human. # indicates the copy number ratio (human/canine) is not available."}

...
## Nomenclature
```{r nomenclature-table, echo=FALSE}
...
- canine RNA-seq (GSE188928): DUX4, DUXC, and DUX-ALT transcriptome in canine skeletal muscle and repeat elements expression stored in `DESeqDataSet` instances
```

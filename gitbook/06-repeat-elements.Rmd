...
In this chapter we performed bioinformatic profiling on repeat elements inferred repeat family and class activation in CinC and HinC transcriptome using gene set enrichment analysis (GSEA). The associated computational methods are:     
- counting reads that overlap with repeat elements   
- identifing DUX4/DUXC affected repeat elements by _DESeq2_         
- comparing CinC to HinC transcriptome    
- analying family and class enrichment in repeat elements     
- estimating peaks distribution in class of repeat elements: show preference on binding to LTR.

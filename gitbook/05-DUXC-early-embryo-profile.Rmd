...
We compared DUXC transcriptome to homologs of the early mouse and human embryo transcriptome to determine whether DUXC transcritome is enriched for genes expressed in the early embryo. Using the homologs of mouse 2C-like signature [@akiyama2015], GSEA suggested that that DUXC transcriptome is enriched for genes expressed in the homologs of mouse 2C-like.
...
## iPSCs 
We used the DUX4 expressed iPSCs [@hendrickson2017] as an early embryo model. 
The hygergeometric test yielded $p-value < 2e-13$.
